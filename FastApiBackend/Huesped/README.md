# Huesped Module Documentation

## Descripción del Módulo
Este módulo maneja las funcionalidades relacionadas con huesped. Aquí puedes describir en detalle la finalidad, los casos de uso y la lógica de negocio del módulo. ¿Qué resuelve este módulo? ¿Cómo se integra con otros módulos del sistema?
...
1. `POST /huesped/v1/create`: Crea un nuevo usuario.
2. `GET /huesped/v1/hola`: Devuelve un mensaje de saludo.
